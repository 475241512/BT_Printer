...
#define RXBUF_HIGH_LEVEL		(UART_RX_BUF_SIZE/4)
#define RXBUF_LOW_LEVEL			(UART_RX_BUF_SIZE/8)
...
#define Uart_RTS_HIGH()     do{   \
            GPIOSetValue(PORT1,GPIO_Pin_5,1);  \
            }while(0)
#define Uart_RTS_LOW()     do{   \
...
extern void Baudrate460800(void);
